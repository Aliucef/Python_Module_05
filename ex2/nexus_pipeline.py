    ...
    def process(self, data: Any) -> Dict:
        ...
        try:
            ...
            if extracted_data is None:
                return {"error": "Failed to extract data", "stage": "transform"}
            ...
            return {"error": f"Transform stage error: {str(e)}", "stage": "transform"}
    ...
    def format_output(self, data: Any) -> str:
        if isinstance(data, dict):
            ...
            if data_type == "string":
                ...
                return f"Processed text: {length} characters, content: '{original}'"
                ...
                return f"Processed list: {count} items (first: {first}, last: {last})"
